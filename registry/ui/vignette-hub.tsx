 ...
 * tech, labelled with the whole roster.
 *
    ...
    >
      ...
      >
        ...
        {placed.map((node, index) => (
          <motion.span
            key={node.id}
            className="absolute -translate-x-1/2 -translate-y-1/2 rounded-full border border-hairline bg-surface-1 px-2.5 py-1 text-[11px] text-ink-2 shadow-raised"
