...
import { GlyphSweep } from "@/registry/ui/glyph-sweep";
...
/** Three survey panels, switched by index — the outgoing camp dissolves into type at its leading edge as the next one sets in behind it. */
export function GlyphSweepDemo() {
  ...
  return (
    <div className="flex w-full flex-col items-center gap-3">
      ...
      <p className="font-mono text-xs text-ink-3">set the next one in type</p>
    </div>
  );
}
