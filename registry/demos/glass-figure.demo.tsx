...
import { GlassFigure } from "@/registry/ui/glass-figure";
import {
  SegmentedControl,
...
/** The proving figure — a torus knot rendered in physically modelled glass — switching between three's built-in presets. Drag the render itself to orbit. */
export function GlassFigureDemo() {
