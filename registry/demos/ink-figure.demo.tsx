...
import { InkFigure } from "@/registry/ui/ink-figure";
import {
  SegmentedControl,
...
/** The proving figure — a torus knot rendered as ink on paper — switching between three's built-in presets. Drag the render itself to orbit. */
export function InkFigureDemo() {
