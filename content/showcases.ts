...
export const SHOWCASES: Showcase[] = [
  {
    ...
    leads: ["pressure-button", "trace-input", "breaker-switch", "code-cells"],
  ...
  },
  {
    ...
    leads: ["gantry-tabs", "slipstream", "magnet-dock", "kinetic-gallery"],
  ...
  },
  {
    ...
    leads: ["callout", "drawer", "bottom-sheet"],
  ...
  },
  {
    ...
    hero: { slug: "spark-chart", mode: "stage" },
    leads: ["readout", "radial-bars", "flapboard", "flow-diagram"],
  ...
  },
  {
    ...
    hero: { slug: "tile-grid", mode: "stage" },
    leads: ["drawer-accordion"],
  ...
  },
  {
    ...
    leads: ["scan-reveal", "timeline-spine"],
  ...
  },
  {
    ...
    hero: { slug: "focus-text", mode: "headline" },
    leads: ["cipher-text"],
  ...
  },
  {
    ...
    leads: ["aurora-ribbon", "iron-filings", "swarm-field", "ripple-surface"],
  ...
  },
  {
    ...
    hero: { slug: "pendulum-wave", mode: "stage" },
    leads: ["tether-rope", "rubber-sheet", "triage-deck", "pull-to-refresh"],
  ...
  },
  {
    ...
    hero: { slug: "heart-tap", mode: "stage" },
    leads: ["spark-burst", "reaction-fly"],
